    ...
    return (
        <>
            <div className="flex flex-col sm:flex-row max-w-[1500px] mx-auto gap-3 sm:gap-1 md:gap-2 px-2 sm:pr-0 sm:ps-4 lg:ps-24 mb-10" >
                ...
                {/*  Left Section  */}
                <div className="left-section py-5 md:py-20 w-full" >
                ...
                <div className='relative sm:w-[90%] '>
                    <div className=" absolute -z-10 bg-cover bg-bottom bg-gradient-to-t from-bg-white opacity-60 to-transparent w-full h-full" style={{ backgroundImage: "url('//shop.boas.co/cdn/shop/files/hero-img-new.jpg?v=1700680068')" }}>
                    </div>

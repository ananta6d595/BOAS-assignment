...
const SavingGrids = ({ data }) => {
    ...
    return (
        <>
            <div className="bg-sky-800 bg-opacity-100 flex flex-col items-center justify-center gap-2 xl:gap-8 text-center aspect-square max-w-xs max-h-80 mx-auto lg:mx-0 w-full h-full">
